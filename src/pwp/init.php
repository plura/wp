...
<!-- Plura™: EXTERNAL JS -->
<script type="text/javascript" src="<?php echo PWP_URL; ?>js/external/jquery-1.11.2.min.js"></script>
<script type="text/javascript" src="<?php echo PWP_URL; ?>js/external/jquery-ui-1.11.2.custom/jquery-ui.min.js"></script>
<link rel="stylesheet" href="<?php echo PWP_URL; ?>js/external/jquery-ui-1.11.2.custom/jquery-ui.min.css" type="text/css" />
