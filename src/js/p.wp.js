...
$(function(){$("li.current-cat").each(function(){for(var a=$(this).parent().parent();a.hasClass("cat-item");)a.addClass("current-cat-ancestor"),a=a.parent().parent()});$(".pwp_nav_ssf.slide").pwpNavSlide();var a=new plura.net.Client({classes:!0});PWP.lang&&$("body").addClass("lang-"+pwp_lang);a.data.ie&&7>a.data.version&&($("input[type=checkbox]").addClass("checkbox"),$("input[type=radio]").addClass("radio"),$("input[type=text]").addClass("text"),$("input[type=submit]").addClass("submit"))});