 ...
 *
 * Date: 2014-05-19 12:30:50 (Mon, 05 May 2014)
 * Revision: 6246
 */
var plura=plura||{};plura.wp=plura.wp||{};
plura.wp.LightBox=function(a){var b=[],d=this,e,c=$.extend(!0,{},{data:pwp_dir+"php/pwp.process.php?type=lightbox",group:"lightbox-gallery",size:"medium",options:{}},a);(function(){var a,f=plura.wp.LightBox.i||0;d.length&&(d.each(function(g){a="IMG"===$(this).prop("tagName")?$(this).parent():$(this);a.prop("id","lightbox_"+f+"_"+g);!1!==c.group&&a.prop("rel",c.group);b[g]='{"id":"'+a.prop("id")+'", "url": "'+a.prop("href")+'"}';a.click(function(a){a.preventDefault()})}),e={json:"["+b.join(",")+"]",
...
$(function(){$("li.current-cat").each(function(){for(var a=$(this).parent().parent();a.hasClass("cat-item");)a.addClass("current-cat-ancestor"),a=a.parent().parent()});$(".pwp_nav_ssf.slide").pwpNavSlide();var a=new plura.net.Client({classes:!0});pwp_lang&&$("body").addClass("lang-"+pwp_lang);a.data.ie&&7>a.data.version&&($("input[type=checkbox]").addClass("checkbox"),$("input[type=radio]").addClass("radio"),$("input[type=text]").addClass("text"),$("input[type=submit]").addClass("submit"))});